...
export function Sidebar() {
  ...
  return (
    <div className="w-64 border-r border-gray-200 h-[calc(100vh-132px)] bg-white">
      <div className="px-4 py-3">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-[15px] font-medium ">Shapes</h2>
          <Button
            variant="ghost"
            size="icon"
            ...
            >
              <div className="flex items-center justify-between py-1.5 px-2 hover:bg-gray-100/80 rounded-md cursor-pointer">
                <div className="flex items-center gap-2">
                  <span className=" text-sm font-normal">
                    <GripVertical className="text-[#98A2B3] h-5 w-5" />
                  </span>
              ...
              <CollapsibleContent>
                <div className="py-1 pl-8">
                  <div className="text-sm text-yadn-primary-text/70">
                    No items
                  </div>
                </div>
              </CollapsibleContent>
