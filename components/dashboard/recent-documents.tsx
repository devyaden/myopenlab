...
export function RecentDocuments() {
  ...
  return (
    <>
      {/* Trigger button - only show when sidebar is closed */}
      {!isMobile && !showSidebar && (
        <Button
          variant="ghost"
          size="icon"
          className="fixed right-0 top-1/2 transform -translate-y-1/2 bg-white shadow-md rounded-l-md rounded-r-none z-10"
      ...
      {(showSidebar || isAnimating) && !isMobile && (
        <aside
          ref={sidebarRef}
          className="fixed right-0 w-80 border-l border-gray-100 bg-white overflow-hidden transition-transform duration-300 ease-in-out z-20 shadow-lg"
          style={{
                  ...
                  <PopoverContent className="w-72">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your most recently accessed documents and canvases
      ...
      {isMobile && !showSidebar && (
        <Button
          variant="ghost"
          size="icon"
          className="fixed right-4 bottom-4 bg-white shadow-lg rounded-full z-10"
          onClick={() => handleToggleSidebar(true)}
        >
